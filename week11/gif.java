...
public class gif extends JFrame implements KeyListener, MouseListener{
    ImageIcon img = new ImageIcon("foxmel-le-sserafim.gif");
    ...
    public void mouseEntered(MouseEvent e){
        tfAction.setText("Mouse enetered the frame");
